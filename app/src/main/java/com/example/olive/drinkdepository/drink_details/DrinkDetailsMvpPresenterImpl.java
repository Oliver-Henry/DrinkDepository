...
public class DrinkDetailsMvpPresenterImpl<V extends IDrinkDetailsMvpView> extends BasePresenter<V> implements IDrinkDetailsMvpPresenter<V> {

    public DrinkDetailsMvpPresenterImpl(IDataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable) {
